...
import "./JBETHERC20ProjectPayerTokensReceiverClone.sol";
import "../utils/juiceboxV2/interfaces/IJBETHERC20ProjectPayerDeployer.sol";
import "@openzeppelin/contracts/proxy/Clones.sol";

/** 
  @notice 
  Deploys project payer contract clones (ERC721/1155 Receiver).
...
*/
contract JBETHERC20ProjectPayerTokensReceiverCloneDeployer {
    //*********************************************************************//
    // ------------------------------ events ----------------------------- //
    //*********************************************************************//
    ...
    constructor() {
        implementation = address(new JBETHERC20ProjectPayerTokensReceiverClone());
    }
    ...
    */
    function cloneProjectPayer(
        ...
        JBETHERC20ProjectPayerTokensReceiverClone(projectPayer).initialize(
            _defaultProjectId,
            _defaultBeneficiary,

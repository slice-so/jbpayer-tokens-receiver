  ...
  */
        ...
        )
    {
        ...
        if (fundingCycle.useDataSourceForPay()) {
            ...
            (_weight, memo, delegate) = IJBFundingCycleDataSource(fundingCycle.dataSource())
                .payParams(_data);
        }
        ...
        )
    {
        ...
        // Scoped section prevents stack too deep. `_reclaimedTokenAmount`, `_currentOverflow`, and `_totalSupply` only used within scope.
        {
            ...
            if (fundingCycle.useDataSourceForRedeem()) {
                ...
                (reclaimAmount, memo, delegate) = IJBFundingCycleDataSource(
    ...
    function _currentTotalOverflowOf(
        ...
        uint256 _totalOverflow18Decimal = _currency == JBCurrencies.ETH
            ...
            : PRBMath.mulDiv(
                _ethOverflow,
                10**18,
                prices.priceFor(JBCurrencies.ETH, _currency, 18)
            );

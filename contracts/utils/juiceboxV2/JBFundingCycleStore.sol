...
contract JBFundingCycleStore is IJBFundingCycleStore, JBControllerUtility {
  ...
  */
    function _configureIntrinsicPropertiesFor(
        ...
        if (
            !_isApproved(_projectId, _baseFundingCycle) || block.timestamp < _baseFundingCycle.start
        )
  ...
  */
        ...
        returns (JBFundingCycle memory fundingCycle)
    {
        ...
        uint256 _packedIntrinsicProperties = _packedIntrinsicPropertiesOf[_projectId][
            _configuration
        ];

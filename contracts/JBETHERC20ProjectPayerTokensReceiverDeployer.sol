...
import "./JBETHERC20ProjectPayerTokensReceiver.sol";
import "./utils/juiceboxV2/interfaces/IJBETHERC20ProjectPayerDeployer.sol";

/** 
  @notice 
  Deploys project payer contracts (ERC721/1155 Receiver).
...
*/
contract JBETHERC20ProjectPayerTokensReceiverDeployer is IJBETHERC20ProjectPayerDeployer {
    //*********************************************************************//
    ...
    */
    function deployProjectPayer(
        ...
        projectPayer = new JBETHERC20ProjectPayerTokensReceiver(
            _defaultProjectId,
            _defaultBeneficiary,

...
import "./JBETHERC20ProjectPayerERC1155Receiver.sol";
import "./utils/juiceboxV2/interfaces/IJBETHERC20ProjectPayerDeployer.sol";

/** 
  @notice 
  Deploys project payer contracts (ERC1155 Receiver).
...
*/
contract JBETHERC20ProjectPayerERC1155ReceiverDeployer is IJBETHERC20ProjectPayerDeployer {
    //*********************************************************************//
    ...
    */
    function deployProjectPayer(
        ...
        projectPayer = new JBETHERC20ProjectPayerERC1155Receiver(
            _defaultProjectId,
            _defaultBeneficiary,

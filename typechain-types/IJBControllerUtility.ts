...
export interface IJBControllerUtilityInterface extends utils.Interface {
  contractName: "IJBControllerUtility";
  functions: {
...
export interface IJBControllerUtility extends BaseContract {
  contractName: "IJBControllerUtility";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IJBControllerUtilityInterface;

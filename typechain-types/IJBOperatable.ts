...
export interface IJBOperatableInterface extends utils.Interface {
  contractName: "IJBOperatable";
  functions: {
...
export interface IJBOperatable extends BaseContract {
  contractName: "IJBOperatable";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IJBOperatableInterface;

...
export interface JBOperatableInterface extends utils.Interface {
  contractName: "JBOperatable";
  functions: {
...
export interface JBOperatable extends BaseContract {
  contractName: "JBOperatable";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: JBOperatableInterface;

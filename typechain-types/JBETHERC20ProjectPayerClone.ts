...
export interface JBETHERC20ProjectPayerCloneInterface extends utils.Interface {
  contractName: "JBETHERC20ProjectPayerClone";
  functions: {
...
export interface JBETHERC20ProjectPayerClone extends BaseContract {
  contractName: "JBETHERC20ProjectPayerClone";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: JBETHERC20ProjectPayerCloneInterface;

...
} from "../IJBPayoutRedemptionPaymentTerminal";
...
export class IJBPayoutRedemptionPaymentTerminal__factory {
  static readonly abi = _abi;
  static createInterface(): IJBPayoutRedemptionPaymentTerminalInterface {
    return new utils.Interface(
      _abi
    ) as IJBPayoutRedemptionPaymentTerminalInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as IJBPayoutRedemptionPaymentTerminal;
  }
}

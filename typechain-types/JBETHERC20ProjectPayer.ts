...
export interface JBETHERC20ProjectPayerInterface extends utils.Interface {
...
export interface JBETHERC20ProjectPayer extends BaseContract {
  contractName: "JBETHERC20ProjectPayer";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: JBETHERC20ProjectPayerInterface;

...
export interface JBETHERC20ProjectPayerTokensReceiverCloneInterface
  extends utils.Interface {
  contractName: "JBETHERC20ProjectPayerTokensReceiverClone";
  functions: {
    ...
    "initialize(uint256,address,bool,string,bytes,bool,address,address)": FunctionFragment;
...
export interface JBETHERC20ProjectPayerTokensReceiverClone
  ...
  interface: JBETHERC20ProjectPayerTokensReceiverCloneInterface;

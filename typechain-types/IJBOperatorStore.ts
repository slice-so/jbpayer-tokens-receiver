...
export interface IJBOperatorStoreInterface extends utils.Interface {
  contractName: "IJBOperatorStore";
  functions: {
...
export interface IJBOperatorStore extends BaseContract {
  contractName: "IJBOperatorStore";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IJBOperatorStoreInterface;

...
export interface JBControllerUtilityInterface extends utils.Interface {
  contractName: "JBControllerUtility";
  functions: {
...
export interface JBControllerUtility extends BaseContract {
  contractName: "JBControllerUtility";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: JBControllerUtilityInterface;
